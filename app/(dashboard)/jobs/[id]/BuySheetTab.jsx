...
export function applyBlankToItem(it, blankData) {
  ...
  return {
    ...
    blank_supplier: blankData.blank_supplier || it.blank_supplier || null,   // which catalog (mig 184)
...
export function FavoritesPicker({ favorites, setFavorites, onAdd, onClose, toggleFav, assignMode, defaultItemName }) {
  ...
  const doAdd = () => {
    ...
    onAdd({
      ...
      blank_supplier: ({ ss: "S&S", ascolour: "AS Colour", laapparel: "LA Apparel" })[selFav.supplier] || null,
      blank_sku: selColor,
