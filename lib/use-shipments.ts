...
// Box identity helpers live in lib/box-key.ts (plain module — server routes
// import them too). Re-exported here so existing client importers keep working.
import { pickupTrackingStamp, normalizeTracking, isRealTracking, shipmentGroupKey } from "./box-key";
export { pickupTrackingStamp, normalizeTracking, isRealTracking, shipmentGroupKey };
