  ...
  try {
    ...
    if (action === "products") {
      ...
      const COLOR_NAMES: Record<string, string> = {
        ...
        STRBW: "STRBW", STRGW: "STRGW",
        STRING: "String Tan", STRNG: "String", STRNW: "STRNW", STRTW: "STRTW",
        TANGR: "Tangerine", TRCAM: "Vintage Wood Camo", TRCM2: "Vintage Camo",
        TRCWH: "TRCWH", TRGR2: "Vintage Grey Camo", TRGRY: "Vintage Grey",
        ULTGR: "Ultra Grey",
